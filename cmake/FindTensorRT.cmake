...
set(NvInferVersion_INCLUDE_FILE "${TensorRT_INCLUDE_DIR}/NvInferVersion.h")
if(NOT EXISTS ${NvInferVersion_INCLUDE_FILE})
    set(NvInferVersion_INCLUDE_FILE "${TensorRT_INCLUDE_DIR}/NvInfer.h")
endif()

if(NvInferVersion_INCLUDE_FILE)
    file(STRINGS ${NvInferVersion_INCLUDE_FILE} TensorRT_MAJOR REGEX "^#define NV_TENSORRT_MAJOR [0-9]+.*$")
    file(STRINGS ${NvInferVersion_INCLUDE_FILE} TensorRT_MINOR REGEX "^#define NV_TENSORRT_MINOR [0-9]+.*$")
    file(STRINGS ${NvInferVersion_INCLUDE_FILE} TensorRT_PATCH REGEX "^#define NV_TENSORRT_PATCH [0-9]+.*$")
...
if(TensorRT_FOUND)
    ...
    if(NOT TARGET TensorRT::TensorRT)
        ...
        set_property(TARGET TensorRT::TensorRT APPEND PROPERTY IMPORTED_LOCATION "${TensorRT_NVINFER_PLUGIN_LIBRARY}")
    endif()
endif()